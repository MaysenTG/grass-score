class GameUsersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @game_user.save
        format.html { redirect_to game_user_url(@game_user), notice: "Game user was successfully created." }
  ...
  def update
    respond_to do |format|
      if @game_user.update(game_user_params)
        format.html { redirect_to game_user_url(@game_user), notice: "Game user was successfully updated." }
  ...
  private
    ...
    def game_user_params
      params.require(:game_user).permit(:name, :game_id)
    end
end
