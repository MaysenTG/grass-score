...
class GameUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create game_user" do
    assert_difference("GameUser.count") do
      post game_users_url, params: { game_user: { game_id: @game_user.game_id, name: @game_user.name } }
    end
  ...
  test "should update game_user" do
    patch game_user_url(@game_user), params: { game_user: { game_id: @game_user.game_id, name: @game_user.name } }
