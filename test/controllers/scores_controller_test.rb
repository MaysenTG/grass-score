...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference("Score.count") do
      post scores_url, params: { score: { game_user_id: @score.game_user_id, round_id: @score.round_id } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { game_user_id: @score.game_user_id, round_id: @score.round_id } }
